...
class Care extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        automaticallyImplyLeading: false, // This will be handled by the main screen
        backgroundColor: Colors.white,
        elevation: 0,
        title: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: GridView.count(
                crossAxisCount: 2,
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(), // To prevent scrolling inside a SingleChildScrollView
                crossAxisSpacing: 4,
                mainAxisSpacing: 4,
                childAspectRatio: 1,
                children: [
